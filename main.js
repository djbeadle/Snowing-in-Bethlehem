...
http.createServer(function(request, response){
	switch(request.url){
		...
		default:
			...
			else if(current_weather.currently["precipProbability"] < config.threshold){
			...
			/* response.write("Probability of "); 
			   ...
			   response.write(".\n\n"); */
				...
				if(current_weather.currently["precipProbability"] >= config.threshold && config.weather.indexOf(current_weather.currently["precipType"])){
